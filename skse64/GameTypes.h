...
public:
	...
	DEFINE_MEMBER_FN(LockForRead, void, 0x00C3EA00);
	DEFINE_MEMBER_FN(LockForWrite, void, 0x00C3EA80);
	DEFINE_MEMBER_FN(UnlockRead, void, 0x00C3ECC0);
	DEFINE_MEMBER_FN(UnlockWrite, void, 0x00C3ECD0);
	DEFINE_MEMBER_FN(LockForReadAndWrite, void, 0x00C3EB80);
	DEFINE_MEMBER_FN(TryLockForWrite, bool, 0x00C3EC70);
};
...
public:
	struct Ref
	{
		...
		DEFINE_MEMBER_FN(ctor, Ref *, 0x00C61430, const char * buf);
		// 31D79EFB15D5E4B34BD32D03A46EAFF65C28ACFB+CB
		DEFINE_MEMBER_FN(ctor_ref, Ref *, 0x00C614E0, const Ref & rhs);
		DEFINE_MEMBER_FN(Set, Ref *, 0x00C615C0, const char * buf);
		// 31D79EFB15D5E4B34BD32D03A46EAFF65C28ACFB+41
		DEFINE_MEMBER_FN(Set_ref, Ref *, 0x00C61680, const Ref & rhs);
		// 46F6DC561A3C9677037E58B55951C58A08E41C47+4A
		DEFINE_MEMBER_FN(Release, void, 0x00C62800);
