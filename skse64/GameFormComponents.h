...
public:
	...
	DEFINE_MEMBER_FN(SetEquipFlag, void, 0x00711DC0, UInt8 flags);
	DEFINE_MEMBER_FN(UpdateEquipment, void, 0x006E3E70, Actor * actor);
	// CDC12817DF3AB5B832348763F433A216BB8A85CA+89
	DEFINE_MEMBER_FN(SetDataFlag, void, 0x006EFAD0, float flag); // Sets a number on the 0x10 object
...
public:
	...
	DEFINE_MEMBER_FN(GetSkillData, UInt32, 0x0077B0C0, UInt32 actorValue, float * level, float * points, float * pointsMax, UInt32 * unk6);
	DEFINE_MEMBER_FN(IncrementLegendary, UInt32, 0x0077B6B0, UInt32 actorValue);
	DEFINE_MEMBER_FN(SetLevel, void, 0x0077B650, UInt32 level);
};
