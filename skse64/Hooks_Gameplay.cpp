...
RelocAddr<uintptr_t> kHook_ContainerMode_Base(0x0088DAB0);
...
RelocAddr<uintptr_t> kHook_BGSKeyword_Base(0x00349350);
...
RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x0091F2F0 + 0x78);
...
RelocAddr<uintptr_t> kHook_Crosshair_LookupREFRByHandle_Enter(0x006D9B20 + 0x88);
...
RelocAddr<uintptr_t> kHook_MapMenuMouseWheel_Enter(0x0090D610 + 0x187);
