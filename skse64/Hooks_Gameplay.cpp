...
RelocAddr<uintptr_t> kHook_ContainerMode_Base(0x008FCC10);
...
RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x0098F660 + 0x78);
...
RelocAddr<uintptr_t> kHook_Crosshair_LookupREFRByHandle_Enter(0x00745320 + 0x88);
...
RelocAddr<uintptr_t> kHook_MapMenuMouseWheel_Enter(0x0097D8F0 + 0x187);
