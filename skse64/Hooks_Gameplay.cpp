...
RelocAddr<uintptr_t> kHook_ContainerMode_Base(0x0089EF70);
...
RelocAddr <char *> g_gameVersion(0x0163B1B8);
RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x00930AC0 + 0x78);
...
RelocAddr<uintptr_t> kHook_Crosshair_LookupREFRByHandle_Enter(0x006EAFE0 + 0x88);
...
RelocAddr<uintptr_t> kHook_MapMenuMouseWheel_Enter(0x0091ED50 + 0x187);
