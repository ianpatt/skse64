...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x00434F80);
	DEFINE_MEMBER_FN(CopyFrom, void, 0x00435020, BSFaceGenModel * other);
	DEFINE_MEMBER_FN(SetModelData, bool, 0x004357A0, const char * meshPath, void * unk1, UInt8 unk2);
	DEFINE_MEMBER_FN(ApplyMorph, UInt8, 0x00435600, BSFixedString * morphName, TESModelTri * triModel, NiAVObject ** headNode, float relative, UInt8 unk1);
	DEFINE_MEMBER_FN(ApplyRaceMorph, UInt8, 0x004354B0, BSFixedString* morphName, TESModelTri* triModel, NiAVObject** headNode, float relative, UInt8 unk1);
};
...
public:
	...
	DEFINE_MEMBER_FN(ApplyMorph, UInt8, 0x004384A0, const char ** morphName, NiAVObject * faceTrishape, float relative, UInt8 unk2);
};
