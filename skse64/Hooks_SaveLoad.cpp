...
RelocAddr <uintptr_t> SaveGame_HookTarget_Enter(0x00611FA0 + 0x2B3);
RelocAddr <uintptr_t> LoadGame_HookTarget_Enter(0x00617560 + 0x34F);
// 691ACD40B8430FBDA081477DEB2A9948ACC235F1+11F
RelocAddr <uintptr_t> ProcessEvents_Enter(0x00648100 + 0x9A);
RelocAddr <uintptr_t> NewGame_Enter(0x009446E0 + 0x59);
RelocAddr <uintptr_t> DeleteSaveGame_Enter(0x00603E90 + 0x77);
RelocAddr <uintptr_t> DeleteSaveGame_Enter2(0x00603F60 + 0x17);
