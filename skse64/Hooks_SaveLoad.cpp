...
RelocAddr <uintptr_t> SaveGame_HookTarget_Enter(0x005BA240 + 0x2B3);
RelocAddr <uintptr_t> LoadGame_HookTarget_Enter(0x005BEE30 + 0x2C5);
// 691ACD40B8430FBDA081477DEB2A9948ACC235F1+11F
RelocAddr <uintptr_t> ProcessEvents_Enter(0x005EC310 + 0x9A);
RelocAddr <uintptr_t> NewGame_Enter(0x008E4BA0 + 0x59);
RelocAddr <uintptr_t> DeleteSaveGame_Enter(0x005AC560 + 0x77);
RelocAddr <uintptr_t> DeleteSaveGame_Enter2(0x005AC630 + 0x17);
