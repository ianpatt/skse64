...
RelocAddr <uintptr_t> SaveGame_HookTarget_Enter(0x005A7A70 + 0x2B3);
RelocAddr <uintptr_t> LoadGame_HookTarget_Enter(0x005AC660 + 0x2C5);
// 691ACD40B8430FBDA081477DEB2A9948ACC235F1+11F
RelocAddr <uintptr_t> ProcessEvents_Enter(0x005D9F50 + 0x9A);
RelocAddr <uintptr_t> NewGame_Enter(0x008D2730 + 0x59);
RelocAddr <uintptr_t> DeleteSaveGame_Enter(0x00599D90 + 0x77);
RelocAddr <uintptr_t> DeleteSaveGame_Enter2(0x00599E60 + 0x17);
