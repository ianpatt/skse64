...
RelocAddr <uintptr_t> SaveGame_HookTarget_Enter(0x005B9C70 + 0x2B3);
RelocAddr <uintptr_t> LoadGame_HookTarget_Enter(0x005BE860 + 0x2C5);
// 691ACD40B8430FBDA081477DEB2A9948ACC235F1+11F
RelocAddr <uintptr_t> ProcessEvents_Enter(0x005EBD40 + 0x9A);
RelocAddr <uintptr_t> NewGame_Enter(0x008E4510 + 0x59);
RelocAddr <uintptr_t> DeleteSaveGame_Enter(0x005ABF90 + 0x77);
RelocAddr <uintptr_t> DeleteSaveGame_Enter2(0x005AC060 + 0x17);
