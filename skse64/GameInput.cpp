...
InputEventDispatcher* InputEventDispatcher::GetSingleton()
{
	...
	static RelocPtr<InputEventDispatcher*> g_inputEventDispatcher(0x0315E2A0);
...
InputManager * InputManager::GetSingleton(void)
{
	...
	static RelocPtr<InputManager*> g_inputManager(0x030FEE10);
...
PlayerControls * PlayerControls::GetSingleton(void)
{
	...
	static RelocPtr<PlayerControls*> g_playerControls(0x030FEE18);
...
MenuControls * MenuControls::GetSingleton(void)
{
	...
	static RelocPtr<MenuControls*> g_menuControls(0x031394E8);
