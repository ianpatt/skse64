...
InputEventDispatcher* InputEventDispatcher::GetSingleton()
{
	...
	static RelocPtr<InputEventDispatcher*> g_inputEventDispatcher(0x02FB92B8);
...
InputManager * InputManager::GetSingleton(void)
{
	...
	static RelocPtr<InputManager*> g_inputManager(0x02F59820);
...
PlayerControls * PlayerControls::GetSingleton(void)
{
	...
	static RelocPtr<PlayerControls*> g_playerControls(0x02F59828);
...
MenuControls * MenuControls::GetSingleton(void)
{
	...
	static RelocPtr<MenuControls*> g_menuControls(0x02F94008);
