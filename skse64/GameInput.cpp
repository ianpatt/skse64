...
InputEventDispatcher* InputEventDispatcher::GetSingleton()
{
	...
	static RelocPtr<InputEventDispatcher*> g_inputEventDispatcher(0x03204B30);
...
InputManager * InputManager::GetSingleton(void)
{
	...
	static RelocPtr<InputManager*> g_inputManager(0x031A5690);
...
PlayerControls * PlayerControls::GetSingleton(void)
{
	...
	static RelocPtr<PlayerControls*> g_playerControls(0x031A5698);
...
MenuControls * MenuControls::GetSingleton(void)
{
	...
	static RelocPtr<MenuControls*> g_menuControls(0x031DFD78);
