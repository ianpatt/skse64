...
RelocAddr<_WorldPtToScreenPt3_Internal> WorldPtToScreenPt3_Internal(0x00C8E670);

RelocAddr<_NiAllocate> NiAllocate(0x00C4A040);
RelocAddr<_NiFree> NiFree(0x00C4A2E0);
