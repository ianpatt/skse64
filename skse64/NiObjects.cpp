...
RelocAddr<_WorldPtToScreenPt3_Internal> WorldPtToScreenPt3_Internal(0x00D27F40);

RelocAddr<_NiAllocate> NiAllocate(0x00CE3590);
RelocAddr<_NiFree> NiFree(0x00CE3830);
