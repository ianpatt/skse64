...
RelocAddr<_WorldPtToScreenPt3_Internal> WorldPtToScreenPt3_Internal(0x00D27E00);

RelocAddr<_NiAllocate> NiAllocate(0x00CE3450);
RelocAddr<_NiFree> NiFree(0x00CE36F0);
