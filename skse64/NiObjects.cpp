...
RelocAddr<_WorldPtToScreenPt3_Internal> WorldPtToScreenPt3_Internal(0x00C8F680);

RelocAddr<_NiAllocate> NiAllocate(0x00C4B050);
RelocAddr<_NiFree> NiFree(0x00C4B2F0);
