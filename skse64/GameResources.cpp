...
FaceGenTriDatabase * FaceGenTriDatabase::GetSingleton(void)
{
	...
	static RelocPtr<FaceGenTriDatabase*> g_FaceGenTriDatabase(0x02F95400);
...
BSFaceGenDB::TRI::DBTraits::Data * FaceGenTriDatabase::GetInvalidEntry(void)
{
	...
	static RelocPtr<BSFaceGenDB::TRI::DBTraits::Data> g_FaceGenTriDatabase_InvalidEntry(0x01E7AA90);
