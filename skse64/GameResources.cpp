...
FaceGenTriDatabase * FaceGenTriDatabase::GetSingleton(void)
{
	...
	static RelocPtr<FaceGenTriDatabase*> g_FaceGenTriDatabase(0x0313A8F0);
...
BSFaceGenDB::TRI::DBTraits::Data * FaceGenTriDatabase::GetInvalidEntry(void)
{
	...
	static RelocPtr<BSFaceGenDB::TRI::DBTraits::Data> g_FaceGenTriDatabase_InvalidEntry(0x02013FB8);
