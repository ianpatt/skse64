...
public:
	...
	DEFINE_MEMBER_FN(ctor, NiStream *, 0x00D209A0);
	DEFINE_MEMBER_FN(dtor, void, 0x00D20C00);
	DEFINE_MEMBER_FN(AddObject, void, 0x00D20E00, NiObject * object);
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x00195BF0);
...
public:
	...
	DEFINE_MEMBER_FN(SaveStream, bool, 0x00D212A0, char ** buffer, UInt32 * length);
	DEFINE_MEMBER_FN(LoadStream, bool, 0x00D21250, char * buffer, UInt32 length);
};
