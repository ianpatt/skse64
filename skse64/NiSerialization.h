...
public:
	...
	DEFINE_MEMBER_FN(ctor, NiStream *, 0x00D1A600);
	DEFINE_MEMBER_FN(dtor, void, 0x00D1A860);
	DEFINE_MEMBER_FN(AddObject, void, 0x00D1AA60, NiObject * object);
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x00195CC0);
...
public:
	...
	DEFINE_MEMBER_FN(SaveStream, bool, 0x00D1AF00, char ** buffer, UInt32 * length);
	DEFINE_MEMBER_FN(LoadStream, bool, 0x00D1AEB0, char * buffer, UInt32 length);
};
