...
public:
	...
	DEFINE_MEMBER_FN(ctor, NiStream *, 0x00D1A420);
	DEFINE_MEMBER_FN(dtor, void, 0x00D1A680);
	DEFINE_MEMBER_FN(AddObject, void, 0x00D1A880, NiObject * object);
...
public:
	...
	DEFINE_MEMBER_FN(SaveStream, bool, 0x00D1AD20, char ** buffer, UInt32 * length);
	DEFINE_MEMBER_FN(LoadStream, bool, 0x00D1ACD0, char * buffer, UInt32 length);
};
