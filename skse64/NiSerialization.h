...
public:
	...
	DEFINE_MEMBER_FN(ctor, NiStream *, 0x00C930F0);
	DEFINE_MEMBER_FN(dtor, void, 0x00C93350);
	DEFINE_MEMBER_FN(AddObject, void, 0x00C93550, NiObject * object);
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x001572E0);
...
public:
	...
	DEFINE_MEMBER_FN(SaveStream, bool, 0x00C939F0, char ** buffer, UInt32 * length);
	DEFINE_MEMBER_FN(LoadStream, bool, 0x00C939A0, char * buffer, UInt32 length);
};
