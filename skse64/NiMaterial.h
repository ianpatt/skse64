...
public:
	...
	DEFINE_MEMBER_FN(CopyFrom, void, 0x014AE9D0, BSLightingShaderMaterial * other);
	DEFINE_MEMBER_FN(dtor_base, void, 0x014AE870);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B0380);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014AFCA0);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B1970);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B0A80);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B0F00);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B33E0);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B1380);
};
