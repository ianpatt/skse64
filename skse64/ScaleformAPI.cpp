...
RelocPtr<ScaleformHeap *> g_scaleformHeap(0x03293890);
...
RelocAddr<_InvokeFunction> InvokeFunction(0x00FC0450);
RelocAddr<_GFxAllocateHeap> GFxAllocateHeap(0x01031720);
