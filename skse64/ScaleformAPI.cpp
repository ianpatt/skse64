...
RelocPtr<ScaleformHeap *> g_scaleformHeap(0x03275AE0);
...
RelocAddr<_InvokeFunction> InvokeFunction(0x0117A770);
RelocAddr<_GFxAllocateHeap> GFxAllocateHeap(0x0117E120);
