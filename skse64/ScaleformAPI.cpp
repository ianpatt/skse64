...
RelocPtr<ScaleformHeap *> g_scaleformHeap(0x030CC600);
...
RelocAddr<_InvokeFunction> InvokeFunction(0x00F1E470);
RelocAddr<_GFxAllocateHeap> GFxAllocateHeap(0x00F90B50);
