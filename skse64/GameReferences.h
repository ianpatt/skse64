...
public:
	...
	DEFINE_MEMBER_FN(GetBaseScale, float, 0x0029EE90);
	DEFINE_MEMBER_FN(IsOffLimits, bool, 0x002AC950);
	// 9C5031E1D6707680E2D9E4A717A225C1137FED59+145
	DEFINE_MEMBER_FN(GetWeight, float, 0x002B8D50);
	DEFINE_MEMBER_FN(GetReferenceName, const char *, 0x002A8810);
	DEFINE_MEMBER_FN(GetWorldspace, TESWorldSpace*, 0x002ABD40);
};
...
public:
	...
	DEFINE_MEMBER_FN(QueueNiNodeUpdate, void, 0x006BAB40, bool updateWeight);
	// CC3C9D131FFDF35E82C6D7182C4F9E42A3ED1EF2+28
	DEFINE_MEMBER_FN(HasPerk, bool, 0x00620A70, BGSPerk * perk);
	DEFINE_MEMBER_FN(GetLevel, UInt16, 0x005FA980);
	DEFINE_MEMBER_FN(SetRace, void, 0x0062EA70, TESRace*, bool isPlayer);
	DEFINE_MEMBER_FN(UpdateWeaponAbility, void, 0x00657040, TESForm*, BaseExtraList * extraData, bool bLeftHand);
	DEFINE_MEMBER_FN(UpdateArmorAbility, void, 0x00656FD0, TESForm*, BaseExtraList * extraData);
	DEFINE_MEMBER_FN(IsHostileToActor, bool, 0x0060DB90, Actor * actor);
	DEFINE_MEMBER_FN(ResetAI, void, 0x00600970, UInt32 unk1, UInt32 unk2);
...
public:
	...
	DEFINE_MEMBER_FN(GetNumTints, UInt32, 0x006DDF30, UInt32 tintType);
	DEFINE_MEMBER_FN(GetTintMask, TintMask *, 0x006DDD80, UInt32 tintType, UInt32 index);
	DEFINE_MEMBER_FN(GetDamage, float, 0x006BAA80, InventoryEntryData * pForm);
	DEFINE_MEMBER_FN(GetArmorValue, float, 0x006BA710, InventoryEntryData * pForm);
};
