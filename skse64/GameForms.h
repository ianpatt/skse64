...
public:
	...
	DEFINE_MEMBER_FN(AddFormToList, void, 0x002D8260, TESForm * form);
	DEFINE_MEMBER_FN(RemoveFormFromList, void, 0x002D8430, TESForm * form);
	DEFINE_MEMBER_FN(RevertList, void, 0x002D8180);
...
public:
	...
	DEFINE_MEMBER_FN(ForceRefTo, UInt32, 0x0038C2D0, UInt32 aliasId, TESObjectREFR * reference);
	DEFINE_MEMBER_FN(NewGame_Internal, UInt8, 0x00387FE0, UInt8 * unk1, UInt8 unk2);
...
public:
	...
	DEFINE_MEMBER_FN(GetNorthRotation, float, 0x00280E50);
};
...
//	void		** _vtbl;	// 00
	...
	static IFormFactory *	GetFactoryForType(UInt32 type)
	{
		...
		static RelocPtr<IFormFactory *> kFactoryList(0x01F5E4A0);
