...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, NiNode*, 0x00D1E960, UInt16 arrBufLen);
};
...
public:
	...
	DEFINE_MEMBER_FN_0(ctor, BSFadeNode *, 0x0147AAB0);
};
...
public:
	...
	DEFINE_MEMBER_FN(AdjustHeadMorph, void, 0x00432E90, UInt32 unk04, UInt32 unk08, float delta);
};
