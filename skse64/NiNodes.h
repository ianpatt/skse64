...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, NiNode*, 0x00C910B0, UInt16 arrBufLen);
};
...
public:
	...
	DEFINE_MEMBER_FN_0(ctor, BSFadeNode *, 0x013AEE80);
};
...
public:
	...
	DEFINE_MEMBER_FN(AdjustHeadMorph, void, 0x003F33F0, UInt32 unk04, UInt32 unk08, float delta);
};
