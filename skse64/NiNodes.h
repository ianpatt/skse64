...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, NiNode*, 0x00EE16E0, UInt16 arrBufLen);
};
...
public:
	...
	DEFINE_MEMBER_FN_0(ctor, BSFadeNode *, 0x014E57C0);
};
...
public:
	...
	DEFINE_MEMBER_FN(AdjustHeadMorph, void, 0x0043A170, UInt32 unk04, UInt32 unk08, float delta);
};
