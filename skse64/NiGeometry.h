...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, NiTriBasedGeom *, 0x00CCF320, NiTriShapeData * geometry);
};
...
public:
	...
	// 
	DEFINE_MEMBER_FN_0(ctor, BSDynamicTriShape *, 0x00CAD680);
};
...
public:
	...
	DEFINE_MEMBER_FN(Copy, NiSkinInstance*, 0x00C8C970);
	DEFINE_MEMBER_FN(ctor, NiSkinInstance *, 0x00CBA6B0);
};
