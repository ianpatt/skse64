...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, NiTriBasedGeom *, 0x00F1F420, NiTriShapeData * geometry);
};
...
public:
	...
	// 
	DEFINE_MEMBER_FN_0(ctor, BSDynamicTriShape *, 0x00EFD5F0);
};
...
public:
	...
	DEFINE_MEMBER_FN(Copy, NiSkinInstance*, 0x00EDC850);
	DEFINE_MEMBER_FN(ctor, NiSkinInstance *, 0x00F0A690);
};
