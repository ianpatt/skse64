...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, NiTriBasedGeom *, 0x00F1F1C0, NiTriShapeData * geometry);
};
...
public:
	...
	// 
	DEFINE_MEMBER_FN_0(ctor, BSDynamicTriShape *, 0x00EFD390);
};
...
public:
	...
	DEFINE_MEMBER_FN(Copy, NiSkinInstance*, 0x00EDC5F0);
	DEFINE_MEMBER_FN(ctor, NiSkinInstance *, 0x00F0A430);
};
