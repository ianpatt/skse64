...
public:
	...
	DEFINE_MEMBER_FN(InitMovie_internal, void, 0x00F10EE0, GFxMovieView* view);
	DEFINE_MEMBER_FN(NextFrame_internal, void, 0x00F10C70, UInt32 arg0, UInt32 arg1);
	DEFINE_MEMBER_FN(ProcessMessage_internal, UInt32, 0x00F10C20, UIMessage* message);
	DEFINE_MEMBER_FN(dtor, void, 0x00F10BC0);
};
...
public:
	...
	DEFINE_MEMBER_FN(LoadSliders, void *, 0x008E63E0, UInt64 unk1, UInt8 unk2);
};
...
public:
	...
	DEFINE_MEMBER_FN_0(dtor, void, 0x008B6250);
	DEFINE_MEMBER_FN_1(Impl_Fn03, void *, 0x008B10B0, void * unk1);
...
public:
	...
	DEFINE_MEMBER_FN_0(dtor, void, 0x008B62C0);
};
...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(SetData, void, 0x0089E650, GFxValue* target);
...
//	DEFINE_MEMBER_FN(AddMessage, void, 0x004503E0, UIMessage * msg);	// old 1.1 implementation
	...
	DEFINE_MEMBER_FN(CreateUIMessageData, IUIMessageData *, 0x00F0A030, const BSFixedString &type);
	...
	DEFINE_MEMBER_FN(ProcessEventQueue_HookTarget, void, 0x00F09EB0);
};
...
public:
	...
	DEFINE_MEMBER_FN(UpdateItem3D, void, 0x008B85C0, InventoryEntryData * objDesc);
	DEFINE_MEMBER_FN(UpdateMagic3D, void, 0x008B85F0, TESForm * form, UInt32 unk1);
	DEFINE_MEMBER_FN(Clear3D, void, 0x008B89B0);
	DEFINE_MEMBER_FN(Render, UInt32, 0x008B82D0);
};
...
private:
	...
	DEFINE_MEMBER_FN(IsMenuOpen, bool, 0x00F053B0, BSFixedString * menuName);
	DEFINE_MEMBER_FN(Register_internal, void, 0x00F07080, const char * name, CreatorFunc creator);
