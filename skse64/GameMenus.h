...
public:
	...
	DEFINE_MEMBER_FN(InitMovie_internal, void, 0x00FB0B20, GFxMovieView* view);
	DEFINE_MEMBER_FN(NextFrame_internal, void, 0x00FB08B0, UInt32 arg0, UInt32 arg1);
	DEFINE_MEMBER_FN(ProcessMessage_internal, UInt32, 0x00FB0860, UIMessage* message);
	DEFINE_MEMBER_FN(dtor, void, 0x00FB0800);
};
...
public:
	...
	DEFINE_MEMBER_FN(LoadSliders, void *, 0x00957F50, UInt64 unk1, UInt8 unk2);
};
...
public:
	...
	DEFINE_MEMBER_FN_0(dtor, void, 0x00927520);
	DEFINE_MEMBER_FN_1(Impl_Fn03, void *, 0x009221E0, void * unk1);
...
public:
	...
	DEFINE_MEMBER_FN_0(dtor, void, 0x00927590);
};
...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(SetData, void, 0x0090F690, GFxValue* target);
...
//	DEFINE_MEMBER_FN(AddMessage, void, 0x004503E0, UIMessage * msg);	// old 1.1 implementation
	...
	DEFINE_MEMBER_FN(AddMessage, void, 0x001AF090, StringCache::Ref * strData, UInt32 msgID, void * objData);
	DEFINE_MEMBER_FN(CreateUIMessageData, IUIMessageData *, 0x00FA9F30, const BSFixedString &type);

	static UIManager *	GetSingleton(void)
	{
		// 5DCBE2588F11BA3D68C45F56DC0FC5D806409F85+C3
		static RelocPtr<UIManager*> g_UIManager(0x020F9D50);
		return *g_UIManager;
	}
	...
	DEFINE_MEMBER_FN(ProcessEventQueue_HookTarget, void, 0x00FA9DB0);
};
...
public:
	...
	static UIStringHolder *	GetSingleton(void)
	{
		...
		static RelocPtr<UIStringHolder *> g_UIStringHolder(0x020F9D58);
...
public:
	...
	static Inventory3DManager * GetSingleton(void)
	{
		...
		static RelocPtr<Inventory3DManager*> g_inventory3DManager(0x03188B98);
	...
	DEFINE_MEMBER_FN(UpdateItem3D, void, 0x00929890, InventoryEntryData * objDesc);
	DEFINE_MEMBER_FN(UpdateMagic3D, void, 0x009298C0, TESForm * form, UInt32 unk1);
	DEFINE_MEMBER_FN(Clear3D, void, 0x00929C80);
	DEFINE_MEMBER_FN(Render, UInt32, 0x009295A0);
};
...
private:
	...
	DEFINE_MEMBER_FN(IsMenuOpen, bool, 0x00FA52B0, BSFixedString * menuName);
	DEFINE_MEMBER_FN(Register_internal, void, 0x00FA6F80, const char * name, CreatorFunc creator);
...
public:
	...
	static MenuManager * GetSingleton(void)
	{
		...
		static RelocPtr<MenuManager *> g_menuManager(0x020F7E00);
