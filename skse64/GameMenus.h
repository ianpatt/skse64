...
public:
	...
	DEFINE_MEMBER_FN(InitMovie_internal, void, 0x00F21E90, GFxMovieView* view);
	DEFINE_MEMBER_FN(NextFrame_internal, void, 0x00F21C20, UInt32 arg0, UInt32 arg1);
	DEFINE_MEMBER_FN(ProcessMessage_internal, UInt32, 0x00F21BD0, UIMessage* message);
	DEFINE_MEMBER_FN(dtor, void, 0x00F21B70);
};
...
public:
	...
	DEFINE_MEMBER_FN(LoadSliders, void *, 0x008F71C0, UInt64 unk1, UInt8 unk2);
};
...
public:
	...
	DEFINE_MEMBER_FN_0(dtor, void, 0x008C7310);
	DEFINE_MEMBER_FN_1(Impl_Fn03, void *, 0x008C1FD0, void * unk1);
...
public:
	...
	DEFINE_MEMBER_FN_0(dtor, void, 0x008C7380);
};
...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(SetData, void, 0x008AF540, GFxValue* target);
...
//	DEFINE_MEMBER_FN(AddMessage, void, 0x004503E0, UIMessage * msg);	// old 1.1 implementation
	...
	DEFINE_MEMBER_FN(AddMessage, void, 0x00170730, StringCache::Ref * strData, UInt32 msgID, void * objData);
	DEFINE_MEMBER_FN(CreateUIMessageData, IUIMessageData *, 0x00F1B2A0, const BSFixedString &type);

	static UIManager *	GetSingleton(void)
	{
		// 5DCBE2588F11BA3D68C45F56DC0FC5D806409F85+C3
		static RelocPtr<UIManager*> g_UIManager(0x01F54770);
		return *g_UIManager;
	}
	...
	DEFINE_MEMBER_FN(ProcessEventQueue_HookTarget, void, 0x00F1B120);
};
...
public:
	...
	static UIStringHolder *	GetSingleton(void)
	{
		...
		static RelocPtr<UIStringHolder *> g_UIStringHolder(0x01F54778);
...
public:
	...
	static Inventory3DManager * GetSingleton(void)
	{
		...
		static RelocPtr<Inventory3DManager*> g_inventory3DManager(0x02FBBDE0);
	...
	DEFINE_MEMBER_FN(UpdateItem3D, void, 0x008C9680, InventoryEntryData * objDesc);
	DEFINE_MEMBER_FN(UpdateMagic3D, void, 0x008C96B0, TESForm * form, UInt32 unk1);
	DEFINE_MEMBER_FN(Clear3D, void, 0x008C9A70);
	DEFINE_MEMBER_FN(Render, UInt32, 0x008C9390);
};
...
private:
	...
	DEFINE_MEMBER_FN(IsMenuOpen, bool, 0x00F16620, BSFixedString * menuName);
	DEFINE_MEMBER_FN(Register_internal, void, 0x00F182F0, const char * name, CreatorFunc creator);
...
public:
	...
	static MenuManager * GetSingleton(void)
	{
		...
		static RelocPtr<MenuManager *> g_menuManager(0x01F52820);
