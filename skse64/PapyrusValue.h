...
public:
	...
	DEFINE_MEMBER_FN(Destroy_Internal, void, 0x01423230);
};
...
public:
	...
	struct ArrayData
	{
		...
		DEFINE_MEMBER_FN(Destroy, void, 0x01430D70);
	};
	...
	DEFINE_MEMBER_FN(Set, void, 0x01426B90, const VMValue * src);
	DEFINE_MEMBER_FN(Destroy, void, 0x01426A90);
	DEFINE_MEMBER_FN(SetArray, void, 0x01425AC0, ArrayData * data);
