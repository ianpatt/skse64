...
RelocAddr<_RegisterPapyrusFunctions> RegisterPapyrusFunctions(0x00A19CB0);
RelocAddr <uintptr_t> RegisterPapyrusFunctions_Start(0x009BE020 + 0xCC3);

RelocAddr<uintptr_t> UnregisterFromSleep_Enter(0x009C3230 + 0x14B);
RelocAddr<uintptr_t> RevertGlobalData_Enter(0x009CA200 + 0x22);
RelocAddr<uintptr_t> RevertGlobalData_Enter2(0x009CA740 + 0x288);
RelocAddr<uintptr_t> SaveRegsSleep_Enter(0x009CCC80 + 0x390);
RelocAddr<uintptr_t> LoadRegsSleep_Enter(0x009CDD60 + 0x2FB);

RelocAddr<uintptr_t> kDFQueueHook_Base(0x009D0310);
