...
RelocAddr<_MoveRefrToPosition> MoveRefrToPosition(0x009D4320);
RelocAddr<_PlaceAtMe_Native> PlaceAtMe_Native(0x009BE290);
RelocAddr<_AddItem_Native> AddItem_Native(0x009BC110);
