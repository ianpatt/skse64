...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074B760, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074B7F0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074B9B0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074B960, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074BB70, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074BB20, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074BBC0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074BA00, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074CE20, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074CE40, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074BC50, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074BD00, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074BD70, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x0074BED0, Actor * form, UInt32 unk04);
};
