...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7B10, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7D10, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7ED0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7F70, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B91D0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B91F0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B8000, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B8120, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B8280, Actor * form, UInt32 unk04);
};
