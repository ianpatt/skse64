...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC250, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC2E0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC4A0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC450, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC660, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC610, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC6B0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC4F0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CD910, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CD930, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC740, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC7F0, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC860, Actor * form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007CC9C0, Actor * form, UInt32 unk04);
};
