...
public:
	...
	DEFINE_MEMBER_FN(SetCameraState, UInt32, 0x00558F90, TESCameraState * cameraState);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x00247D20);
	DEFINE_MEMBER_FN(SetNorthRotation, void, 0x00248170, float northRotation);
};
...
public:
	...
	static PlayerCamera *	GetSingleton(void)
	{
		...
		static RelocPtr<PlayerCamera*> g_playerCamera(0x031A5478);
	...
	DEFINE_MEMBER_FN(UpdateThirdPerson, void, 0x008FB340, bool weaponDrawn);
};
