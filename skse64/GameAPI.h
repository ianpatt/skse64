...
public:
	...
	DEFINE_MEMBER_FN(Allocate, void *, 0x00C26F00, size_t size, size_t alignment, bool aligned);
	DEFINE_MEMBER_FN(Free, void, 0x00C27350, void * buf, bool aligned);
};
...
public:
	...
	DEFINE_MEMBER_FN(VPrint, void, 0x00889680, const char * fmt, va_list args);
