...
public:
	...
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x014AA0E0);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 6 (+0x30)
	DEFINE_MEMBER_FN(Impl_GetParam, UInt64 *, 0x014A97B0, UInt32 idx, BSFixedString * nameOut, UInt64 * typeOut);
	DEFINE_MEMBER_FN(Impl_Invoke, UInt32, 0x014A99B0, UInt64 unk0, UInt64 unk1, VMClassRegistry * registry, VMState * unk3);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 0x10 (+0x80)
	DEFINE_MEMBER_FN(Impl_Fn10, BSFixedString *, 0x014A9890);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 0x12 (+0x90)
	DEFINE_MEMBER_FN(Impl_Fn12, bool, 0x014A98B0, UInt32 idx, UInt64 out);
...
public:
	...
	DEFINE_MEMBER_FN(Impl_ctor, NativeFunction *, 0x014A9E90, const char * fnName, const char * className, UInt32 unk0, UInt32 numParams);
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x014AA0E0);	// same as NativeFunctionBase dtor
