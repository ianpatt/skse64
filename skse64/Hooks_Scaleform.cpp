...
RelocAddr<_UIOpenJournalMenu> UIOpenJournalMenu(0x009ACD90);
...
//	void						** _vtbl;		// 00
	...
	DEFINE_MEMBER_FN(ctor_data, StandardItemData *, 0x00903C00, GFxMovieView ** movieView, InventoryEntryData * objDesc, UInt64 unk);
	...
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x00904B90 + 0x97);
...
//	void			** _vtbl;	// 00
	...
	DEFINE_MEMBER_FN(ctor_data, MagicItemData *, 0x00954F70, GFxMovieView ** movieView, TESForm * pForm, int unk); // unk is ignored by ctor

	static uintptr_t GetCtorHookAddress()
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x00956590 + 0x97);
		return kCtorHookAddress.GetUIntPtr();
	}
...
namespace favMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetItemData_Base(0x0092D170);
	...
	RelocAddr<uintptr_t> kSetMagicData_Base(0x0092E180);
	...
	RelocAddr<uintptr_t> kSetVampireData_Base(0x0092E410);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x00921050);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x00917940);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00917E70);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00917B80);
	...
	RelocAddr<uintptr_t> kExtendCategoryArgs_Base(0x00925540);
...
{
	RelocPtr<UInt64> kCtor_Base(0x00652850 + 0xDA1);	// WinMain+15
...
RelocAddr <uintptr_t> kInstallHooks_Enter(0x0116FB40 + 0x1DD);
