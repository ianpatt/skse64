...
RelocAddr<_UIOpenJournalMenu> UIOpenJournalMenu(0x00924050);
...
//	void						** _vtbl;		// 00
	...
	DEFINE_MEMBER_FN(ctor_data, StandardItemData *, 0x00881B90, GFxMovieView ** movieView, InventoryEntryData * objDesc, UInt64 unk);
	...
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x00882B60 + 0x97);
...
//	void			** _vtbl;	// 00
	...
	DEFINE_MEMBER_FN(ctor_data, MagicItemData *, 0x008CE580, GFxMovieView ** movieView, TESForm * pForm, int unk); // unk is ignored by ctor

	static uintptr_t GetCtorHookAddress()
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x008CFBA0 + 0x97);
		return kCtorHookAddress.GetUIntPtr();
	}
...
namespace favMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetItemData_Base(0x008A6F30);
	...
	RelocAddr<uintptr_t> kSetMagicData_Base(0x008A7F40);
	...
	RelocAddr<uintptr_t> kSetVampireData_Base(0x008A81D0);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x0089B180);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x00891A70);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00891FA0);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00891CB0);
	...
	RelocAddr<uintptr_t> kExtendCategoryArgs_Base(0x0089F610);
...
{
	RelocPtr<UInt64> kCtor_Base(0x005D3F10 + 0xE72);	// WinMain+15
...
RelocAddr <uintptr_t> kInstallHooks_Enter(0x00F10D20 + 0x1DD);
