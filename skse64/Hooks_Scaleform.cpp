...
RelocAddr<_UIOpenJournalMenu> UIOpenJournalMenu(0x00925070);
...
//	void						** _vtbl;		// 00
	...
	DEFINE_MEMBER_FN(ctor_data, StandardItemData *, 0x00882D60, GFxMovieView ** movieView, InventoryEntryData * objDesc, UInt64 unk);
	...
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x00883D30 + 0x97);
...
//	void			** _vtbl;	// 00
	...
	DEFINE_MEMBER_FN(ctor_data, MagicItemData *, 0x008CF550, GFxMovieView ** movieView, TESForm * pForm, int unk); // unk is ignored by ctor

	static uintptr_t GetCtorHookAddress()
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x008D0B70 + 0x97);
		return kCtorHookAddress.GetUIntPtr();
	}
...
namespace favMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetItemData_Base(0x008A8040);
	...
	RelocAddr<uintptr_t> kSetMagicData_Base(0x008A9050);
	...
	RelocAddr<uintptr_t> kSetVampireData_Base(0x008A92E0);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x0089C290);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x00892C40);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00893170);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00892E80);
	...
	RelocAddr<uintptr_t> kExtendCategoryArgs_Base(0x008A0720);
...
{
	RelocPtr<UInt64> kCtor_Base(0x005D5090 + 0xE91);	// WinMain+15
...
RelocAddr <uintptr_t> kInstallHooks_Enter(0x00F11D10 + 0x1DD);
