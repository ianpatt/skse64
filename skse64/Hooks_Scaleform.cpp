...
RelocAddr<_UIOpenJournalMenu> UIOpenJournalMenu(0x009ACFF0);
...
//	void						** _vtbl;		// 00
	...
	DEFINE_MEMBER_FN(ctor_data, StandardItemData *, 0x00903E60, GFxMovieView ** movieView, InventoryEntryData * objDesc, UInt64 unk);
	...
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x00904DF0 + 0x97);
...
//	void			** _vtbl;	// 00
	...
	DEFINE_MEMBER_FN(ctor_data, MagicItemData *, 0x009551D0, GFxMovieView ** movieView, TESForm * pForm, int unk); // unk is ignored by ctor

	static uintptr_t GetCtorHookAddress()
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x009567F0 + 0x97);
		return kCtorHookAddress.GetUIntPtr();
	}
...
namespace favMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetItemData_Base(0x0092D3D0);
	...
	RelocAddr<uintptr_t> kSetMagicData_Base(0x0092E3E0);
	...
	RelocAddr<uintptr_t> kSetVampireData_Base(0x0092E670);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x009212B0);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x00917BA0);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x009180D0);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00917DE0);
	...
	RelocAddr<uintptr_t> kExtendCategoryArgs_Base(0x009257A0);
...
{
	RelocPtr<UInt64> kCtor_Base(0x00652AB0 + 0xDA1);	// WinMain+15
...
RelocAddr <uintptr_t> kInstallHooks_Enter(0x0116FDA0 + 0x1DD);
