...
RelocAddr<_UIOpenJournalMenu> UIOpenJournalMenu(0x00995850);
...
//	void						** _vtbl;		// 00
	...
	DEFINE_MEMBER_FN(ctor_data, StandardItemData *, 0x008EE3C0, GFxMovieView ** movieView, InventoryEntryData * objDesc, UInt64 unk);
	...
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x008EF350 + 0x97);
...
//	void			** _vtbl;	// 00
	...
	DEFINE_MEMBER_FN(ctor_data, MagicItemData *, 0x0093E930, GFxMovieView ** movieView, TESForm * pForm, int unk); // unk is ignored by ctor

	static uintptr_t GetCtorHookAddress()
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x0093FF50 + 0x97);
		return kCtorHookAddress.GetUIntPtr();
	}
...
namespace favMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetItemData_Base(0x00917210);
	...
	RelocAddr<uintptr_t> kSetMagicData_Base(0x00918220);
	...
	RelocAddr<uintptr_t> kSetVampireData_Base(0x009184B0);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x0090B530);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x00901EE0);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00902410);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00902120);
	...
	RelocAddr<uintptr_t> kExtendCategoryArgs_Base(0x0090F8F0);
...
{
	RelocPtr<UInt64> kCtor_Base(0x00640420 + 0xDA1);	// WinMain+15
...
RelocAddr <uintptr_t> kInstallHooks_Enter(0x00FAB2D0 + 0x1DD);
