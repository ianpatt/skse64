...
RelocAddr<_UIOpenJournalMenu> UIOpenJournalMenu(0x009958B0);
...
//	void						** _vtbl;		// 00
	...
	DEFINE_MEMBER_FN(ctor_data, StandardItemData *, 0x008EE230, GFxMovieView ** movieView, InventoryEntryData * objDesc, UInt64 unk);
	...
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x008EF1C0 + 0x97);
...
//	void			** _vtbl;	// 00
	...
	DEFINE_MEMBER_FN(ctor_data, MagicItemData *, 0x0093E990, GFxMovieView ** movieView, TESForm * pForm, int unk); // unk is ignored by ctor

	static uintptr_t GetCtorHookAddress()
	{
		static RelocAddr<uintptr_t> kCtorHookAddress(0x0093FFB0 + 0x97);
		return kCtorHookAddress.GetUIntPtr();
	}
...
namespace favMenuDataHook
{
	...
	RelocAddr<uintptr_t> kSetItemData_Base(0x00917270);
	...
	RelocAddr<uintptr_t> kSetMagicData_Base(0x00918280);
	...
	RelocAddr<uintptr_t> kSetVampireData_Base(0x00918510);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x0090B460);
...
{
	RelocAddr<uintptr_t> kSetData_Base(0x00901D50);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00902280);
...
{
	// 
	RelocAddr<uintptr_t> kSetData_Base(0x00901F90);
	...
	RelocAddr<uintptr_t> kExtendCategoryArgs_Base(0x0090F950);
...
{
	RelocPtr<UInt64> kCtor_Base(0x00640290 + 0xDA1);	// WinMain+15
...
RelocAddr <uintptr_t> kInstallHooks_Enter(0x00FAB4D0 + 0x1DD);
