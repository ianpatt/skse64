...
public:
	...
	DEFINE_MEMBER_FN(Destroy, void, 0x01491E00);
	DEFINE_MEMBER_FN(GetVariable, SInt32, 0x01493090, BSFixedString * name);
	// 
	DEFINE_MEMBER_FN(GetFunction, IFunction*, 0x014967D0, const char * fnName);
};
...
//	void						** _vtbl;								// 0000
	...
	// 
	DEFINE_MEMBER_FN(UnregisterFromSleep_Internal, void, 0x009D9FA0, UInt64 handle);	// AE: using one function earlier due to inlining
	DEFINE_MEMBER_FN(RevertGlobalData_Internal, bool, 0x009E3FB0);
	// 4DF4B0288419C72FBF262CE2DBBAAFE7D9713C51+390
	DEFINE_MEMBER_FN(SaveRegSleepEventHandles_Internal, bool, 0x009E5370, void * handleReaderWriter, void * saveStorageWrapper);
	// 4F9ECB23ABD5935D4160213D8A06DB7A94E6B988+2FB
	DEFINE_MEMBER_FN(LoadRegSleepEventHandles_Internal, bool, 0x009E6610, void * handleReaderWriter, void * loadStorageWrapper);	// AE: using one function earlier due to inlining

	// 96B4034421813AABF0DBF8B2B00A84CC25FB9CA0+112
	DEFINE_MEMBER_FN(QueueDelayFunctor_Internal, bool, 0x009DAE10, void** pFunctor);
...
public:
	...
	struct Output
	{
		...
		DEFINE_MEMBER_FN(Resize, bool, 0x009D5630, UInt32 len);
	};
