...
public:
	...
	DEFINE_MEMBER_FN(Destroy, void, 0x0141D5E0);
	DEFINE_MEMBER_FN(GetVariable, SInt32, 0x0141E870, BSFixedString * name);
	// 
	DEFINE_MEMBER_FN(GetFunction, IFunction*, 0x01421FB0, const char * fnName);
};
...
//	void						** _vtbl;								// 0000
	...
	// 
	DEFINE_MEMBER_FN(UnregisterFromSleep_Internal, void, 0x009C27E0, UInt64 handle);	// AE: using one function earlier due to inlining
	DEFINE_MEMBER_FN(RevertGlobalData_Internal, bool, 0x009CC4D0);
	// 4DF4B0288419C72FBF262CE2DBBAAFE7D9713C51+390
	DEFINE_MEMBER_FN(SaveRegSleepEventHandles_Internal, bool, 0x009CD890, void * handleReaderWriter, void * saveStorageWrapper);
	// 4F9ECB23ABD5935D4160213D8A06DB7A94E6B988+2FB
	DEFINE_MEMBER_FN(LoadRegSleepEventHandles_Internal, bool, 0x009CEB30, void * handleReaderWriter, void * loadStorageWrapper);	// AE: using one function earlier due to inlining

	// 96B4034421813AABF0DBF8B2B00A84CC25FB9CA0+112
	DEFINE_MEMBER_FN(QueueDelayFunctor_Internal, bool, 0x009C3650, void** pFunctor);
...
public:
	...
	struct Output
	{
		...
		DEFINE_MEMBER_FN(Resize, bool, 0x009BDEF0, UInt32 len);
	};
