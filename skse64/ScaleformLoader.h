...
public:
	...
	DEFINE_MEMBER_FN_1(AddVirtualImage, UInt8, 0x00FA0190, NiTexture ** texture);
	DEFINE_MEMBER_FN_1(ReleaseVirtualImage, UInt8, 0x00FA0610, NiTexture ** texture);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, GFxLoader *, 0x00F231E0);

	DEFINE_MEMBER_FN(LoadMovie, bool, 0x00F23910, IMenu* menu, GFxMovieView** viewOut, const char* name, int scaleMode, float backGroundAlpha);	// probably in subclass
};
