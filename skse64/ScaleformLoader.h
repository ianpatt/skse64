...
public:
	...
	DEFINE_MEMBER_FN_1(AddVirtualImage, UInt8, 0x00F8D550, NiTexture ** texture);
	DEFINE_MEMBER_FN_1(ReleaseVirtualImage, UInt8, 0x00F8D9D0, NiTexture ** texture);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, GFxLoader *, 0x00F105F0);

	DEFINE_MEMBER_FN(LoadMovie, bool, 0x00F10D20, IMenu* menu, GFxMovieView** viewOut, const char* name, int scaleMode, float backGroundAlpha);	// probably in subclass
};
