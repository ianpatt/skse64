...
//// Global instances
// Performance: Cache-line alignment (64 bytes) to prevent false sharing
// These globals are accessed on every event dispatch, so aligning them to separate
// cache lines prevents CPU cache thrashing when multiple threads access different events
