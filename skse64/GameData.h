...
//	NiTArray<BGSAddonNode*>				addonNodes;		// D20
	...
	DEFINE_MEMBER_FN(LoadScripts, UInt32, 0x0017D8D0);
};
...
public:
	...
	DEFINE_MEMBER_FN(EquipItem, void, 0x0066F520, Actor * actor, TESForm * item, BaseExtraList * extraData, SInt32 count, BGSEquipSlot * equipSlot, bool withEquipSound, bool preventUnequip, bool showMsg, void * unk);
	DEFINE_MEMBER_FN(UnequipItem, bool, 0x0066FD10, Actor * actor, TESForm * item, BaseExtraList * extraData, SInt32 count, BGSEquipSlot * equipSlot, bool unkFlag1, bool preventEquip, bool unkFlag2, bool unkFlag3, void * unk);
};
...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(GetFaceGenModelMapEntry, bool, 0x003EF300, const char * meshPath, BSFaceGenModelMap ** entry);
		DEFINE_MEMBER_FN(SetFaceGenModelMapEntry, void, 0x003EF1B0, const char * meshPath, BSFaceGenModel * model);
	...
	DEFINE_MEMBER_FN(RegenerateHead, void, 0x003EC430, BSFaceGenNiNode * headNode, BGSHeadPart * head, TESNPC * npc);
	DEFINE_MEMBER_FN(ApplyMorph, void, 0x003EBD30, BSFaceGenNiNode* faceGenNode, BGSHeadPart* headPart, BSFixedString* morphName, float relative);
};
...
public:
	...
	DEFINE_MEMBER_FN(CreateOffensiveEnchantment, EnchantmentItem *, 0x005D2800, tArray<MagicItem::EffectItem> * effectArray);
	DEFINE_MEMBER_FN(CreateDefensiveEnchantment, EnchantmentItem *, 0x005D28A0, tArray<MagicItem::EffectItem> * effectArray);
	DEFINE_MEMBER_FN(CreatePoison, void, 0x005D29F0, tArray<MagicItem::EffectItem> * effectArray, AlchemyItem ** poison);
	DEFINE_MEMBER_FN(CreatePotion, void, 0x005D2940, AlchemyItem ** potion, tArray<MagicItem::EffectItem> * effectArray);
	DEFINE_MEMBER_FN(ScheduleForDeletion, void, 0x005D2D20, TESForm *);
};
...
public:
	...
	private:
	DEFINE_MEMBER_FN(Save_Internal, bool, 0x005B9C70, int unk1, UInt32 unk2, const char * name);
	DEFINE_MEMBER_FN(Load_Internal, bool, 0x005BA3B0, const char * name, int unk1, UInt32 unk2, UInt32 unk3);

	DEFINE_MEMBER_FN(SaveGame_HookTarget, void, 0x005AFBE0, UInt64 *unk0);
	DEFINE_MEMBER_FN(LoadGame_HookTarget, bool, 0x005B02F0, UInt64 *unk0, UInt32 unk1, UInt32 unk2, void *unk3);

	DEFINE_MEMBER_FN(ProcessEvents_Internal, void, 0x005BCF20);
	DEFINE_MEMBER_FN(DeleteSavegame, void, 0x005B9C00, const char * saveName, UInt32 unk1);
};
