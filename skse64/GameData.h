...
//	NiTArray<BGSAddonNode*>				addonNodes;		// D20
	...
	DEFINE_MEMBER_FN(LoadScripts, UInt32, 0x001BC9F0);
};
...
public:
	...
	DEFINE_MEMBER_FN(EquipItem, void, 0x006CBA50, Actor * actor, TESForm * item, BaseExtraList * extraData, SInt32 count, BGSEquipSlot * equipSlot, bool withEquipSound, bool preventUnequip, bool showMsg, void * unk);
	DEFINE_MEMBER_FN(UnequipItem, bool, 0x006CC240, Actor * actor, TESForm * item, BaseExtraList * extraData, SInt32 count, BGSEquipSlot * equipSlot, bool unkFlag1, bool preventEquip, bool unkFlag2, bool unkFlag3, void * unk);
};
...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(GetFaceGenModelMapEntry, bool, 0x0042EDA0, const char * meshPath, BSFaceGenModelMap ** entry);
		DEFINE_MEMBER_FN(SetFaceGenModelMapEntry, void, 0x0042EC50, const char * meshPath, BSFaceGenModel * model);
	...
	DEFINE_MEMBER_FN(RegenerateHead, void, 0x0042BED0, BSFaceGenNiNode * headNode, BGSHeadPart * head, TESNPC * npc);
	DEFINE_MEMBER_FN(ApplyMorph, void, 0x0042B7D0, BSFaceGenNiNode* faceGenNode, BGSHeadPart* headPart, BSFixedString* morphName, float relative);
};
...
public:
	...
	DEFINE_MEMBER_FN(CreateOffensiveEnchantment, EnchantmentItem *, 0x0062E890, tArray<MagicItem::EffectItem> * effectArray);
	DEFINE_MEMBER_FN(CreateDefensiveEnchantment, EnchantmentItem *, 0x0062E930, tArray<MagicItem::EffectItem> * effectArray);
	DEFINE_MEMBER_FN(CreatePoison, void, 0x0062EA80, tArray<MagicItem::EffectItem> * effectArray, AlchemyItem ** poison);
	DEFINE_MEMBER_FN(CreatePotion, void, 0x0062E9D0, AlchemyItem ** potion, tArray<MagicItem::EffectItem> * effectArray);
	DEFINE_MEMBER_FN(ScheduleForDeletion, void, 0x0062EDB0, TESForm *);
};
...
public:
	...
	private:
	DEFINE_MEMBER_FN(Save_Internal, bool, 0x00611FA0, int unk1, UInt32 unk2, const char * name);
	DEFINE_MEMBER_FN(Load_Internal, bool, 0x006126E0, const char * name, int unk1, UInt32 unk2, UInt32 unk3);

	DEFINE_MEMBER_FN(SaveGame_HookTarget, void, 0x00607AE0, UInt64 *unk0);
	DEFINE_MEMBER_FN(LoadGame_HookTarget, bool, 0x006081F0, UInt64 *unk0, UInt32 unk1, UInt32 unk2, void *unk3);

	DEFINE_MEMBER_FN(ProcessEvents_Internal, void, 0x00615310);
	DEFINE_MEMBER_FN(DeleteSavegame, void, 0x00611F30, const char * saveName, UInt32 unk1);
};
