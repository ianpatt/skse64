...
1. **Event Dispatch Hash Map** - [PapyrusEvents.h:164-169](skse64/PapyrusEvents.h#L164-L169)
...
2. **Data-Oriented Event Storage** - [PapyrusEvents.h:92-165](skse64/PapyrusEvents.h#L92-L165)
   - Replaced std::set tree structure with contiguous vector arrays
   - Event handlers stored in sequential memory for cache-friendly iteration
   - Impact: **2-4x faster event iteration** from improved cache locality
   - Enables future SIMD optimizations

3. **Cache-Line Alignment** - [PapyrusEvents.cpp:13-35](skse64/PapyrusEvents.cpp#L13-L35)
...
4. **String Allocation Optimization** - [PluginManager.cpp:185-196](skse64/PluginManager.cpp#L185-L196)
...
5. **Plugin Name Hash Map** - [PluginManager.cpp:461-477](skse64/PluginManager.cpp#L461-L477)
...
6. **Serialization UID Hash Map** - [Serialization.cpp:475-487](skse64/Serialization.cpp#L475-L487)
